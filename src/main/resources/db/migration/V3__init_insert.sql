...
insert into users(id, entry_date, entry_user, version, email, lat, lng, location, phone, name, password, account_status)
values (null, CURRENT_TIMESTAMP(), 'system', 0, 'user@user.pl', 50.0411867, 21.999119599999972,
        'Rzeszow', '605854368', 'Robert Sikora', '$2a$10$CAw31P3luMH2K0u97S4l0OCpiowiw8hHSKVc5OwsOMzuXATYLSYgW', 'ACTIVE');
...
insert into users(id, entry_date, entry_user, version, email, lat, lng, location, phone, name, password, account_status)
values (null, CURRENT_TIMESTAMP(), 'system', 0, 'admin@admin.pl', 50.0411867, 21.999119599999972,
        'Rzeszow', '605854368', 'Robert Sikora', '$2a$10$ce33e4Bn93pDThjtyGk4pu9.OGQJ5Lin64gf.eebjSVcHGmC4oCTy', 'ACTIVE');
